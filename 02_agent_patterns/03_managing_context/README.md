...
|  |  |
|---|---|
| **Section** | [Agent patterns](https://ai.developer.meta.com/docs/getting-started/cookbook#agent-patterns) |
...
OpenCode has built-in support for the **Meta** provider. First, get an API key from the **[API dashboard](https://ai.developer.meta.com)**.
