...
Provide your Meta API key (from the [API dashboard](https://ai.developer.meta.com)) and a gateway token, restart, and smoke-test:
...
| ![Granting camera access to VisionClaw in the Meta AI app](./assets/glasses-permission.png) | ![Confirming the glasses connection in VisionClaw Settings](./assets/glasses-settings.png) |
| :---: | :---: |
...
- **Meta** — [Model API](https://ai.developer.meta.com/docs/getting-started/overview) · [image understanding](https://ai.developer.meta.com/docs/features/image-understanding) · [Wearables Device Access Toolkit (iOS)](https://github.com/facebook/meta-wearables-dat-ios)
