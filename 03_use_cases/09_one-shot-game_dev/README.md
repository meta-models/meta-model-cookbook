...
**Connect the Meta provider.** Grab an API key from the [API dashboard](https://ai.developer.meta.com), launch OpenCode, and run:
...
- **`muse-spark-1.1`** ([Model API docs](https://ai.developer.meta.com/docs)): OpenAI-compatible; point any OpenAI client at `https://api.meta.ai/v1`.
